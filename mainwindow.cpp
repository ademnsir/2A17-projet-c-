...
void MainWindow::on_menuBouton_Gestion_produits_clicked()
{
    windowcommidites c;
    c.setModal(true);
...
void MainWindow::on_menuBouton_Gestion_visites_2_clicked()
{  windowvisite v;
    v.setModal(true);
...
void MainWindow::on_menuBouton_Gestion_reclamations_3_clicked()
{
    windowreclamation rr;
       rr.setModal(true);
